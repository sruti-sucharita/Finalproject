      ...
      <header className="App-header">
        ...
        <div className="product-grid">
          ...
          <div className="input-group">
              ...
              <input type="text" id="name" name="name" className="wide-input" placeholder='sruti swain'required />
            </div>
            <div className="input-group">
              <label htmlFor="email"></label>
              <input type="email" id="email" name="email" className="wide-input" placeholder='sruti123@gmail.com'required />
            </div>
            <div className="input-group">
            <label htmlFor="address"></label>
            <input type="text" id="address" name="address" className="wide-input1" placeholder='I found your site well informed.' required />
            </div>
